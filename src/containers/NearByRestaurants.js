...
class NearByRestaurants extends Component {
    ...
    getData(){
       ...
       //                  let rcoordinates = this.state.restaurants[i].position.split(',');
       //                      this.props.getRestaurantsDistance(rcoordinates, this.currentLatitude, this.currentLongitude,this.state.restaurants[i]).then(() => {
