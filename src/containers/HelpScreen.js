...
class AboutUsScreen extends Component {
    ...
    getData(){
        this.props.help().then(() => {
                    console.log(this.props.misc.help["0"].help_text);
                    this.setState({
                        help: this.props.misc.help["0"].help_text,
                    });
                })
    }
    getNetinfo(){
    ...
    render() {
        ...
        return (
        (this.state.netstatus)?<View style={{
                  flex: 1,
                        ...
                        margin:responsiveWidth(5)
                                ...
                                <Hyperlink onPress={ (url, text) =>{
                                     ...
                                     // alert(url + ", " + text)
                                           ...
                                           linkStyle={ { color: '#1E90FF', fontSize: responsiveFontSize(1.5) } }
                                           linkDefault={ true }>
