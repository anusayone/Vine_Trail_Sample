...
class WineriesScreen extends Component {
    ...
    onBackPress = () => {
        console.log("back button of wineries listing page");
                        ...
                        (this.state.isRestaurantsAvailable)
                            ? <FlatList
                                ...
                                renderItem={({item,index}) =>
                                    ...
                                    />}
                                //keyExtractor={(item, index) => 'w'+item.id.toString()}
                                onEndReached={()=>{
...
export default connect(mapStateToProps, mapDispatchToProps)(WineriesScreen);
