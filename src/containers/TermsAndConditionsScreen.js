...
class TermsAndConditionsScreen extends Component {
    ...
    getData(){
    this.props.getTermsAndConditions().then(() => {
               // console.log(this.props.user.termsAndConditions["0"].terms_text);
                this.setState({
                    termsAndConditions: this.props.user.termsAndConditions["0"].terms_text,
                });
            })
    }
    componentDidMount() {
                        ...
                        margin:responsiveWidth(5)
                                ...
                                <Hyperlink onPress={ (url, text) =>{
                                     ...
                                     // alert(url + ", " + text)
                                           ...
                                           linkStyle={ { color: '#1E90FF', fontSize: responsiveFontSize(1.7) } }
                                           linkDefault={ true }>
