...
//        if (this.state.goToNearBy) {
//            this.props.navigation.navigate(Types.NEARBY);
//        } else {
//            if (category == 'Lodging') {
...
//        }
    ...
    getData(){
      console.log(this.props.navigation.state.params.isFromNearBy);
              if (this.props.navigation.state.params.isFromNearBy) {
                  this.setState({goToNearBy: true});
              }
              this.setState({
            ...
            <View style={{
                ...
                <View style={{
                    ...
                    <ImageLoad
                        ...
                        source={(selectedRestaurant.banner_url==null||selectedRestaurant.banner_url=='')
                            ?require('../../assets/images/placeholder_image.png')
                            :{uri:selectedRestaurant.banner_url}}
                    />
                    <Image
                        style={{
                        height:responsiveHeight(40),
                    ...
                    <View style={{
                        ...
                        <TouchableWithoutFeedback
                            onPress={() => {
                            this.props.navigation.navigate(Types.POI_MAP_DIRECTION_SCREEN,selectedRestaurant);
                                    }}>
                            <View style={{
                                borderRadius:5,
                ...
                <ScrollView
                    ...
                    marginBottom:25,
                        ...
                        {/*<View style={{*/}
                            ...
                            {/*width:responsiveWidth(100),*/}
                           {/*borderWidth:0.6,borderColor:'#ababab',*/}
                            {/*flexDirection:'row',*/}
                        {/*}}>*/}
                            {/*<View style={{*/}
                                    {/*flexDirection:'row',*/}
                                ...
                                {/*<Image*/}
                                   ...
                                   {/*resizeMode: 'cover'*/}
                                   {/*}}*/}
                                    {/*source={require('../../assets/images/detail_page_clock_icon.png')}*/}
                                {/*/>*/}
                                {/*<Text style={{paddingLeft:5,*/}
                                    {/*fontSize:responsiveFontSize(1.6),*/}
                                    {/*fontFamily:'Roboto-Regular',*/}
                                    {/*color:'#4c4b4b'}}>Working Hours :*/}
                                    {/*<Text style={{*/}
                                        {/*fontFamily:'Roboto-Bold',*/}
                                        {/*color:'#000'*/}
                                 {/*}}> {(selectedRestaurant.working_hours == 0) ? 24*/}
                                        {/*: (selectedRestaurant.working_hours == null) ? 0*/}
                                            {/*: selectedRestaurant.working_hours} Hours</Text></Text>*/}
                            {/*</View>*/}
                            {/*<View style={{*/}
                                    {/*flexDirection:'row',*/}
                                    {/*paddingTop:15,*/}
                                ...
                                {/*<Image*/}
                                    {/*style={{*/}
                                           ...
                                           {/*resizeMode: 'cover'*/}
                                           {/*}}*/}
                                    {/*source={require('../../assets/images/detail_page_time_icon.png')}*/}
                                {/*/>*/}
                                {/*<Text style={{fontSize:responsiveFontSize(1.6),*/}
                                    {/*paddingLeft:5,*/}
                                        {/*fontFamily:'Roboto-Regular',*/}
                                        {/*color:'#4c4b4b'}}>Time to reach :*/}
                                    {/*<Text style={{*/}
                                            {/*fontFamily:'Roboto-Bold',*/}
                                            {/*color:'#000',*/}
                                     {/*}}*/}
                                          {/*ellipsizeMode='tail'*/}
                                          {/*numberOfLines={1}>{(this.state.duration != '') ? this.state.duration : "Not Available"}*/}
                                        {/*/!*{(selectedRestaurant.duration=='')?"Not Available":selectedRestaurant.duration}*!/*/}
                                    {/*</Text></Text>*/}
                            {/*</View>*/}
                        {/*</View>*/}
                        <View style={{
                            ...
                            <Text style={{
                                ...
                                paddingTop:responsiveHeight(1)}}>{selectedRestaurant.title}
                            </Text>
                            <Text style={{
                                paddingLeft:10,
                                fontFamily:'Roboto-Regular',
                                ...
                                paddingTop:4}}>
                                Distance : {(this.state.distance != '') ? this.state.distance : "Not Available"}
                                {/*{(selectedRestaurant.distancee==''||selectedRestaurant.distancee==null)?"Not Available":selectedRestaurant.distancee}*/}
                            </Text>
                            <Text style={{
                                paddingLeft:10,
                                fontFamily:'Roboto-Regular',
...
export default connect(mapStateToProps, mapDispatchToProps)(RestaurantsDetail);
